    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-primary" id="mainNav">
        <div class="container">
            ...
            <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;">
                <h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp S.S. HOSPITALS</h4>
            </a>
        ...
        <div class="col-md-9" style="margin-top: 40px;left: 80px;">
            ...
            <center>
                <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist" style="width: 40%;">
                    <li class="nav-item">
                    <button type="button" class="btn btn-danger" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Patient</button>
                    </li>
                    <li class="nav-item">
                    <button type="button" class="btn btn-primary" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Doctor</button>
                    </li>
                    <li class="nav-item">
                    <button type="button" class="btn btn-success" id="profile-tab" data-toggle="tab" href="#admin" role="tab" aria-controls="admin" aria-selected="false">Admin</button>
                    </li>
                </ul>
            </center>
