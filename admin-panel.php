...
if(isset($_POST['app-submit']))
{
  ...
  $cur_date = date("Y-m-d");
  date_default_timezone_set('Asia/Kolkata54  ');
  $cur_time = date("H:i:s");
...
/*if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> S.S. Hospitals</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> S.S. Hospital </a>
